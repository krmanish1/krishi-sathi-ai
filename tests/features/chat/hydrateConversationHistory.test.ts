import { hydrateLocalThreadFromServerHistory } from "@/features/chat/hydrateConversationHistory";
import * as endpoints from "@/shared/api/endpoints";
import * as repo from "@/features/chat/chatMessagesRepo";

jest.mock("@/shared/api/endpoints", () => ({
  getConversationHistory: jest.fn(),
}));

jest.mock("@/features/chat/chatMessagesRepo", () => ({
  MAIN_THREAD_ID: "main",
