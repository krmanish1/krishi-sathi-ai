import { askAgent, extractTextContent } from "@/shared/api/routing";
import { setGemmaBackend } from "@/shared/ondevice/gemma";
import type { AgentContext } from "@/shared/api/routing";
import { postQuery } from "@/shared/api/endpoints";
...
describe("askAgent routing", () => {
  ...
  it("online + any intent to backend", async () => {
  ...
  it("USE_ONDEVICE fallback with low confidence to canEscalate true when online", async () => {
